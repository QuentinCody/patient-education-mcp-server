...
export function registerGetSchema(server: McpServer, env?: SchemaEnv) {
    const handler = createGetSchemaHandler("PATED_DATA_DO", "pated");
    ...
    server.registerTool(
        "pated_get_schema",
        {
            ...
            description:
                "Get schema information for staged patient education data. Shows table structures and row counts. " +
